<div class="container white-bg-padding">
    ...
    <h2 class="form-signin-heading">Request a Quote</h2>
    ...
    <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2">
        <form action="<?php echo site_url('account/register') ?>" class="form-signin" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <input name="phone" type="number" class="form-control" placeholder="TDurden@firstchoicegarage.com" required autofocus>
            </div>
            <div class="form-group">
                <label>Services Requested</label>
                <div style="padding:15px;">
                    <label><input type="checkbox"> Flooring</label>
                    <label><input type="checkbox"> Cabinetry</label>
                    <label><input type="checkbox"> Wall Organizing</label>
                    <label><input type="checkbox"> Vehicle Lift</label>
