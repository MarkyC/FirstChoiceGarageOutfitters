<div class="container">
    ...
    <div class="product">
        ...
        <div class="row">
            <div class="col-md-4">
                <img class="img-responsive"
                     src="<?php echo base_url(); ?>img/cabinets/geneva/shelf-3.jpg"
                     alt="3 Shelf Wall Unit">
            </div>
            <div class="col-md-8">
        ...
        <div class="row">
            <div class="col-md-4">
                <img class="img-responsive"
                     src="<?php echo base_url(); ?>img/cabinets/geneva/shelf-2.jpg"
                     alt="2 Shelf Wall Unit">
            </div>
            <div class="col-md-8">
